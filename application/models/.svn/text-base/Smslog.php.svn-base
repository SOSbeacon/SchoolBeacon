...
class Sos_Model_Smslog extends MainModel
{
...
function __construct() {
    ...
    /**
     * sets column message type varchar(300)     
     *
     * @param string $data
     * @return Sos_Model_Smslog     
     *
    ...
    /**
     * gets column message type varchar(300)
     * @return string     
     */
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Sos_Model_SmslogMapper());
        }
        return $this->_mapper;
    }
