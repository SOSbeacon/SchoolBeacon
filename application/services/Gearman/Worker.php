<?php
class Sos_Service_Gearman_Worker
{
    /**
     * Register Function
     * @var string
    ...
    public function __construct($logFile = null)
    {
        ...
        $this->_worker = Sos_Service_Gearman_Manager::getWorker();
        ...
        Sos_Service_Gearman_Manager::getLogger()->log('[Worker initialized]', Zend_Log::INFO);
