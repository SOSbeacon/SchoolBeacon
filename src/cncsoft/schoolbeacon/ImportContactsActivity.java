...
import cncsoft.schoolbeacon.adapter.ImportContactsAdapter;
import cncsoft.schoolbeacon.oauth.OauthRegister;
import cncsoft.schoolbeacon.util.ContactInfo;
import cncsoft.schoolbeacon.util.ContactInfoList;
import cncsoft.schoolbeacon.util.TextUtil;
...
public class ImportContactsActivity extends GeneralActivity  {
	...
	private void getYahooContactList(HttpResponse response) {
		...
		String data = cncsoft.schoolbeacon.http.HttpRequest.GetText(response);
		try {
