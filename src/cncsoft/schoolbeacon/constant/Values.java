package cncsoft.schoolbeacon.constant;

import java.net.URLEncoder;

public class Values {
	
	public static final String Url = "http://sosbeacon.org/school";
	...
	public final static String directoryApp   = "SchoolBeacon";
	...
	public static final String loginUrl = Url + "/users?format=json&email=%s&password=%s&email=%s&imei=%s&phoneType=%s";//Url use when login auto  in SplashActivity
