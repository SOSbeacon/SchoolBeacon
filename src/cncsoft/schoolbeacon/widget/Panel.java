...
package cncsoft.schoolbeacon.widget;
...
public class Panel extends LinearLayout {
    ...
    OnTouchListener touchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View touchListener, MotionEvent event) {
            //Log.d(TAG, "View: " + touchListener.toString() + " x: " + event.getX() + " y: " + event.getY());
    ...
    class PanelOnGestureListener implements OnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            //Log.d(TAG, "mOrientation " + mOrientation + " dx " + distanceX + " dy " + distanceY);
