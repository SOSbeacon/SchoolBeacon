...
public class OffLineModeActivity extends Activity {
    ...
    Spinner spBroadcastType;

    Spinner spnBroadcastGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spBroadcastType = (Spinner) findViewById(R.id.spnSelectBroadcast);
        ...
        try {
            ...
            try {
                ...
                mlocManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 0, 0,
                        mlocListener);
                Location curloc = mlocManager
                        .getLastKnownLocation(LocationManager.NETWORK_PROVIDER);
                latitude = String.valueOf(curloc.getLatitude());
                longitude = String.valueOf(curloc.getLongitude());
            } catch (Exception ex) {
                Toast.makeText(this, getString(R.string.offline_error_pgs), Toast.LENGTH_SHORT)
                        .show();
                Log.d("SOSbeacon", "Error : Can't detect location");
            }
        }
        ArrayAdapter<String> adapterSend = new ArrayAdapter<String>(this, R.layout.spinner_layout,
                broadCast);
        adapterSend.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spBroadcastType.setAdapter(adapterSend);

        spnBroadcastGroup = (Spinner) findViewById(R.id.spnCall);
        ArrayAdapter<String> adapterCall = new ArrayAdapter<String>(this, R.layout.spinner_layout,
                selectGroup);
        adapterCall.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spnBroadcastGroup.setAdapter(adapterCall);
        ...
        etMessage.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tvCharRemain.setText(String.format(getString(R.string.offline_sms_char_remain),
                        count));
            }
        });
            ...
            switch (getResultCode()) {
                case Activity.RESULT_OK:
                    if (type == 1) {
                        ...
                        spnBroadcastGroup.setSelection(0);
