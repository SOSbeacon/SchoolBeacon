...
import cnc.schoolbeacon.adapter.ImportContactsAdapter;
import cnc.schoolbeacon.oauth.OauthRegister;
...
public class ImportContactsActivity extends GeneralActivity  {
	...
	private void getYahooContactList(HttpResponse response) {
		...
		String data = cnc.schoolbeacon.http.HttpRequest.GetText(response);
		try {
